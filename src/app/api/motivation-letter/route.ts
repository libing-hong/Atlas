...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (process.env.ATLAS_MOTIVATION_LETTER_ENABLED !== "true") throw apiException("ENTITLEMENT_REQUIRED", 403);
